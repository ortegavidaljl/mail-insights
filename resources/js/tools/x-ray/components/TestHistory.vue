<template>
	...
	<Transition name="slide-fade">
		<div v-if="isTestHistoryShown" class="z-20 transition-all w-80 max-h-[400px] left-[-145px] top-[45px] absolute backdrop-blur-xs text-white bg-gray-800/90 shadow-lg overflow-auto rounded-sm p-4 overflow-x-auto">
			...
			<div class="h-[calc(100%-290px)] text-gray-900 bg-white/80 shadow-sm overflow-auto rounded-sm p-4 overflow-x-auto dark:bg-gray-900 dark:border-gray-700 dark:text-white">
